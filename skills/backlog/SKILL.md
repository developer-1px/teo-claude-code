...
백로그에 넣는 항목이 `docs/1-projects/*/prds/` 또는 `docs/2-areas/*/prds/`에 PRD가 있는 경우, 해당 PRD를 backlog 문서로 이동한다. prds/에는 구현할 것만 남겨야 하므로, 보류 결정 = PRD를 prds/에서 내리는 것이다.

```bash
git mv docs/1-projects/<service>/prds/feature-prd.md docs/5-backlogs/
```
